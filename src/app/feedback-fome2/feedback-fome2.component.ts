...
@Component({
  selector: 'app-feedback-fome2',
  templateUrl: './feedback-fome2.component.html',
  styleUrls: ['./feedback-fome2.component.css']
})
export class FeedbackFome2Component implements OnInit {
